...
const TwoColumn = tw.div`flex flex-col md:flex-row justify-between max-w-screen-xl mx-auto py-4 md:py-4 items-center`;
...
const Feature = tw.div`mt-10 lg:mt-8 flex items-center md:items-start flex-col md:mr-4 `;
