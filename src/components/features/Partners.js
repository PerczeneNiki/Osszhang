...
export default ({
  subheading = "Társ szervezeteink",
  heading = <>Jó <span tw="text-primary-500">együttműködni.</span></>,
  description = "Együttműködés más szervezetekkel az egészségesebb jövőért.",
